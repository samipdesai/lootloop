...
Thanks for reviewing! Contact: support@lootloop.us
```
...
- Contact is **support@lootloop.us** (live iCloud+ custom-domain mailbox). For the
  App Review *contact phone* field, use a virtual/Google Voice number, not a personal cell.
